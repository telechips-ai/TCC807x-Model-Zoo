...
<table border="1" cellspacing="0" cellpadding="5">
    ...
    <tbody>
        <tr>
            ...
            <td align="right">5.5460</td> <!-- Inference Time(msec): EVB -->
            <td align="right">0.73648</td> <!-- Evaluation Result: FP32 -->
            <td align="right">0.7129</td> <!-- Evaluation Result: INT8 -->
            <td align="center">INT8</td> <!-- Quantization Bit -->
            <td align="right">1.096</td> <!-- Compiled NN Information: Graph file (.json) (KB) -->
            <td align="right">0.031</td> <!-- Compiled NN Information: weight & bias (.params) (KB) -->
            <td align="right">25.755</td> <!-- Compiled NN Information: Network (.so) (MB) -->
