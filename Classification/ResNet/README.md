# ResNet Benchmark on TCC807x
The following table shows benchmark results for the ResNet-50 v2 model running on the **TCC807x** NPU.
ResNet is a family of deep residual networks designed for image classification tasks.

The ResNet-50 v2 model is evaluated using the ILSVRC 2012 (ImageNet) validation dataset and compiled with the TVM toolkit.
...
<table border="1" cellspacing="0" cellpadding="5">
    ...
    <tbody>
        <tr>
            <td align="center" colspan="1">ResNet</td>
            <td align="center" rowspan="1" class="variant"><a href="ResNet50-v2">50-v2</a></td> <!-- Model -->
            ...
            <td align="right">0.735</td> <!-- Evaluation Result: FP32 -->
            <td align="right">0.704</td> <!-- Evaluation Result: INT8 -->
            <td align="center">INT8</td> <!-- Quantization Bit -->
            <td align="right">1.753</td> <!-- Compiled NN Information: Graph file (.json) (KB) -->
            <td align="right">0.031</td> <!-- Compiled NN Information: weight & bias (.params) (KB) -->
            <td align="right">18.228</td> <!-- Compiled NN Information: Network (.so) (MB) -->
            <td align="center"><a href="https://github.com/onnx/models/tree/main/validated/vision/classification/resnet">GitHub</a></td> <!-- References: Link -->
...
- The model's raw output consists of logit values corresponding to all 1000 ImageNet classes.
